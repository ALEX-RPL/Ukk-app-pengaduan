...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <a href="{{ route('siswa.aspirasi.index') }}" class="text-blue-600 hover:text-blue-900">
        ...
        <div class="flex justify-between items-start mb-4">
            <div>
                ...
                <div class="space-y-1 text-sm text-gray-600">
                    <p><span class="font-medium">Pelapor:</span> {{ $aspirasi->user->name }}</p>
    ...
    @if($aspirasi->responses->count() > 0)
        <div class="bg-white shadow-md rounded-lg p-6">
            <h3 class="text-xl font-bold text-gray-900 mb-4">Umpan Balik & Histori Progres</h3>
