...
@section('title', 'Buat Kritik/Saran')

@section('content')
<div class="max-w-3xl mx-auto">
    <h2 class="text-2xl font-bold text-gray-900 mb-6">Buat Kritik/Saran</h2>

    <div class="bg-white shadow-md rounded-lg p-6">
        <form method="POST" action="{{ route('siswa.kritik-saran.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text"
                       name="judul"
                       id="judul"
                       placeholder="Contoh: Perbaikan Fasilitas Toilet"
                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500
